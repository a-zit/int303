 ...
 * @author INT303
 */
public class GetDataFromProductServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (code != null) {
            ...
            Product p = productJpaCtrl.findProduct(code);
            if (p==null) {
                request.setAttribute("message", "Product code '" + code +"' does not exist !!!");
            } else {
