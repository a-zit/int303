...
public class VerySimpleCalculatorServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int xValue = Integer.valueOf(xStr);
        int yValue = Integer.valueOf(yStr);
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1 style='color: blue'> &nbsp; &nbsp; &nbsp; x = " + xStr + "</h1>");
            out.println("<h1> &nbsp; &nbsp; &nbsp; y = " + yStr + "</h1>");
            out.println("<hr>");
            out.println("<h1> &nbsp; &nbsp; &nbsp; Result = " + result + "</h1>");
            out.println("<br><br><br><br><br><hr>");
            out.println("Your browser is : "+ yourBrowser);
            out.println("</body>");
            out.println("</html>");
        }
    }
